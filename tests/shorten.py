...
def test_v2_with_password():
    ...
    assert response.status_code == 401, f"Expected 401 password page, got {response.status_code}"
...
def test_metrics():
    ...
    print(f"✅ Metrics: {data['total-shortlinks']} links, {data['total-clicks']} clicks")
