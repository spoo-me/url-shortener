...
function openKeySuccessModal(token, tokenPrefix) {
    ...
    setTimeout(async () => {
        try {
            ...
            customTopNotification('KeyCopied', 'API key automatically copied to clipboard', 5, 'success');
